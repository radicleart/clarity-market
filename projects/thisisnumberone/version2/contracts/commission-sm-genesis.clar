...
(define-public (pay (ft-trait <ft-trait>) (id uint) (price uint))
    (begin
        (try! (contract-call? ft-trait transfer (/ (* price u6) u100) tx-sender 'SPZRAE52H2NC2MDBEV8W99RFVPK8Q9BW8H88XV9N)) ;; artist
        ...
        (try! (contract-call? ft-trait transfer (/ (* price u2) u100) tx-sender 'SP1P89TEC03E29V5MYJBSCC8KWR1A243ZG2R8DYB1)) ;; marketplace
        (ok true)
    )
)
