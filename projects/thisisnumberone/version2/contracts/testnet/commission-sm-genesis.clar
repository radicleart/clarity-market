...
(define-public (pay (ft-trait <ft-trait>) (id uint) (price uint))
    (begin
        (try! (contract-call? ft-trait transfer (/ (* price u6) u100) tx-sender 'ST2KAEEGWXNBFWTT5DJG14WH3G2CEFPWV99YPJPMR none)) ;; artist
        ...
        (try! (contract-call? ft-trait transfer (/ (* price u2) u100) tx-sender 'ST1WJY09D3DEE45B1PY8TAV838VCH9HNEJXB2ZBPQ none)) ;; marketplace
        (ok true)
    )
)
